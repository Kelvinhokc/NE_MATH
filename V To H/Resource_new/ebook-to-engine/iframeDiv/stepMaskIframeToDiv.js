...
function addPopupMaskButton(tempBtnArray){
	...
	scriptCallFrame += "<script>function callFrame(popupDiv) {$('#mask').show();$('div.layer_mask').hide();popupDiv.show();}function closeFrame() {$('div.layer_mask').hide();$('#mask').hide();}</script>";
